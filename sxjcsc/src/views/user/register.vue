    ...
    <div class="w-100">
        <div class="bigbox m-0-auo">
            <div class="top">
                ...
                <span class="text-3 font-24 mt-35 tit ml-30" style="vertical-align: top">欢迎注册</span>
            </div>
        </div>
        <div class="w-100 box" :style="{backgroundImage: 'url('+bg+')'}">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm"  class="demo-ruleForm">
                <div class="kuang">
                    ...
                    <div class="btn font-18 text-white text-center pointer" @click="reg">立即注册</div>
        ...
        methods:{
            ...
            checkMob(phone){
                return new Promise(resolve => {
                    this.JCService.UserServer.Index({phone:phone}).then(e=>{
                        if (e.status == 0){
                            resolve(0)
                        } else if (e.status == 1) {
                            resolve(1)
            ...
            reg(){
                if (this.checked){
                    this.$refs.ruleForm.validate((valid)=>{
                        if (valid){
                            this.JCService.UserServer.Information(this.ruleForm).then(e=>{
                                if (e.status == 1) {
