    ...
    <div class="setbox">
        <div class="title px-20 font-16 text-3">
            ...
            <div class="float-right">
                <div class="item text-3 font-12 float-left  pointer"><i class="el-icon-sell mr-5"></i>批量上架</div>
                <div class="item text-3 font-12 float-left ml-10 pointer"><i class="el-icon-delete mr-5"></i>批量删除</div>
            </div>
        </div>
        ...
        <Del :showDel="showDel" @closeDel="closeDel" :delTxt="'您确定要删除该商品？'" @delete="delGoods"></Del>
    </div>
</template>
<script>
...
<style scoped lang="scss">
    .setbox{
        ...
        .title{
            ...
            .el-icon-delete,.el-icon-sell{color: #8a8a8a;font-size: 15px;}
        }
        .edit{background: #006DFF;color: #ffffff}
        .upper{background: red;color: #ffffff}
...
<style scoped>
    /deep/.el-table .cell{text-align: center;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;}
